...
func main() {
	...
	http.HandleFunc("/api2/201602929/call-api1", callAPI1Handler())
	http.HandleFunc("/api2/201602929/call-api3", callAPI3Handler())

	fmt.Println("Iniciando API2 en el puerto :", api2_port)

	if err := http.ListenAndServe(":"+api2_port, nil); err != nil {
...
func callAPI1Handler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		fmt.Println("GET /api2/201602929/call-api1")
...
func callAPI3Handler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		fmt.Println("GET /api2/201602929/call-api3")
